        ...
        >
            <div className="p-4">
                <div className="grid grid-cols-4 gap-3 mb-4">
                    <button
                        className={`flex flex-col items-center justify-center p-3 rounded-xl ${wifiEnabled ? "bg-blue-500" : "bg-gray-700"
                            }`}
                        onClick={toggleWifi}
                    >
                    ...
                    <button
                        className={`flex flex-col items-center justify-center p-3 rounded-xl ${bluetoothEnabled ? "bg-blue-500" : "bg-gray-700"
                            }`}
                    ...
                    <button
                        className={`flex flex-col items-center justify-center p-3 rounded-xl ${isDarkMode ? "bg-blue-500" : "bg-gray-700"
                            }`}
                    ...
                    <button
                        className={`flex flex-col items-center justify-center p-3 rounded-xl ${isFullscreen ? "bg-blue-500" : "bg-gray-700"
                            }`}

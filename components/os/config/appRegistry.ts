...
export interface AppMetadata {
    ...
    icon: LucideIcon;
    iconImage?: string;          // Custom image icon path (overrides icon+gradient when set)
...
export const APP_REGISTRY: Record<string, AppMetadata> = {
    ...
    'bec-pay': {
        ...
        icon: CreditCard,
        iconImage: '/os-assets/icons/billdesk.svg',
    ...
    'bec-chat': {
        ...
        icon: MessageCircle,
        iconImage: '/os-assets/icons/bec-chat.svg',
    ...
    'bec-portal': {
        ...
        icon: GraduationCap,
        iconImage: '/os-assets/icons/bec-portal.png',
    ...
    'account-manager': {
        ...
        icon: UserPlus,
        iconImage: '/os-assets/icons/account-manager.svg',
    ...
    'admit-app': {
        ...
        icon: GraduationCap,
        iconImage: '/os-assets/icons/admit.png',
        iconColor: 'from-emerald-500 to-teal-600',
        iconSolid: '#10b981',
        category: 'admin',
        isCore: true,
    ...
    'subject-directory': {
        ...
        icon: Book,
        iconImage: '/os-assets/icons/subject-directory.svg',
    ...
    'subject-assigner': {
        ...
        icon: Users,
        iconImage: '/os-assets/icons/subject-assigner.svg',
    ...
    're-registration': {
        ...
        icon: FileSignature,
        iconImage: '/os-assets/icons/re-registration.svg',
        iconColor: 'from-purple-500 to-purple-600',
        iconSolid: '#8b5cf6',
        category: 'admin',
        isCore: true,
    ...
    'course-registration': {
        ...
        icon: BookOpen,
        iconImage: '/os-assets/icons/course-registration.svg',
    ...
    'teaching-assigner': {
        ...
        icon: ClipboardList,
        iconImage: '/os-assets/icons/teaching-assigner.svg',
    ...
    'faculty-dashboard': {
        ...
        icon: GraduationCap,
        iconImage: '/os-assets/icons/faculty-dashboard.svg',
    ...
    'marks-upload': {
        ...
        iconImage: '/os-assets/icons/marks-evaluator.svg',
    ...
    'attendance-upload': {
        ...
        icon: CalendarCheck,
        iconImage: '/os-assets/icons/attendance.svg',
    ...
    'cr-assigner': {
        ...
        icon: Star,
        iconImage: '/os-assets/icons/cr-assigner.png',
